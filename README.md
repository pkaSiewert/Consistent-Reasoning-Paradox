...
Figures 4, 5, and 6 of the main paper report the behaviour of GPT-5.5 Pro, Codex, and DeepSeek V4-Pro on a selection of prompts we designed. Figure 4 has the prompts 4a, 4b, and 4c, Figure 5 has the prompts 5a, 5b, 5c, and 5d, and Figure 6 has the prompts 5a, 5b-alt, 5c-alt, and 5d-alt. This repository also contains information on earlier models that we collected for earlier versions of the paper.
